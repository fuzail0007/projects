...
if(isset($_GET['edit_pro']))
{
	...
	$get_pro = "SELECT * FROM wproducts where product_id='$get_id'";
	...
	$row_pro=mysqli_fetch_array($run_pro);
		...
		$get_cat = "select * from wcategories where cat_id='$pro_cat'";
		$run_cats=mysqli_query($con, $get_cat);
		$row_cats=mysqli_fetch_array($run_cats);
		$cat_title=$row_cats['cat_title'];
		
		$get_brand = "select * from wbrands where brand_id='$pro_brand'";
    ...
    <table align="center" width="795" border="2" bgcolor="#187eae">
        ...
        <tr>
            ...
            <select name="product_brand" />
            	...
            	<?php
				$get_brands = "SELECT * FROM wbrands";
...
<?php
	...
	move_uploaded_file($product_image_tmp,"w_product_images/$product_image");
	 ...
	 $update_product = "update wproducts set product_cat='$product_cat',product_brand='$product_brand',product_quantity='$product_quantity',product_title='$product_title',product_price='$product_price',product_desc='$product_desc',product_image='$product_image',product_keywords='$product_keywords' where product_id = '$update_id'";
