...
<div class="navbar navbar-default navbar-fixed-top">
	<div class="container-fluid" >
		<div class="navbar-header" >
			<a href="index2.php" class="navbar-brand">TheLeatherCity</a>
		</div>
			<ul class="nav navbar-nav">
				<!--<li><a href="index2.php"><span class="glyphicon glyphicon-home"></span></a></li>-->
				...
				<!--<li class="dropdown">
					<a href="#" data-toggle="dropdown" class="dropdown-toggle">All Products <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="#">Goat Raw Skins</a></li>
						<li><a href="#">Sheep Raw skins</a></li>
						<li><a href="#">Cow and Hides raw skins</a></li>
						<li><a href="#">Tanning chemicals</a></li>
						<li><a href="#">Dyes and Finishing Chemicals</a></li>
					</ul>
				</li>-->
			...
			<ul class="nav navbar-nav navbar-right">
				...
				?>
				<!--<li><a href="wheader.inc.php" data-toggle='modal' data-target='#popUpWindow1'><span class='glyphicon glyphicon-user'></span> Sign Up</a></li>-->
				...
				if(!isset($_SESSION['customer_email']))
				{
					...
					<li><a href='login_referer.php'><span class='glyphicon glyphicon-log-in'></span> Sign In</a></li>";
					*/
			...
			<div class="nav navbar-nav form-inline navbar-right" style="padding:10px;">
				...
				<form method = "get" action = "w_results.php" enctype="multipart/form-data" >
	...
	<div class="container-fluid">
			...
			?>
			<a href="cart2.php" style="text-decoration:none;">Go To Your <span class="glyphicon glyphicon-shopping-cart"></span>: <span class="badge"><?php total_items2();?></span></a> <b><i class="fa fa-inr" style="font-size:18px"></i></b>: <span class="badge"><?php total_price2(); ?></span>
