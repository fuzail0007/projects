...
include("includes/db.php");
	if(isset($_GET['pro_id']))
	{
        ...
        $get_pro = "SELECT * FROM wproducts WHERE product_id='$product_id'";
		...
		$get_cats_name = "SELECT cat_title FROM wcategories WHERE cat_id='$cats_name'";
		...
		$get_brands_name = "SELECT brand_title FROM wbrands WHERE brand_id='$brands_name'";
		...
		echo "
				...
				<img class='img-thumbnail' src = 'admin_area/w_admin_src/w_product_images/$pro_image' width='400' height='300' /><br/>
				<a style='text-decoration:none; margin-left:130px;' href='admin_area/w_admin_src/w_product_images/$pro_image'>View Full Size Image</a>
				
				<br><br>
				<a class='btn btn-success btn-xm' style='text-decoration:none;' href='index2.php'>Go Back</a>
				
				
				<a href='index2.php?add2_cart=$pro_id'><button class='btn btn-primary btn-xm' style = 'margin-left:220px;'>Add to Cart</button></a>
				<br><br>
	...
	//}
		...
		{
			$p_cmnt = mysql_real_escape_string($_POST['comment']);
			...
			$insert_cmnt = "INSERT INTO product_reviews (product_id, customer_email, comment) VALUES ('$pro_id','$c_email','$p_cmnt')";
			
			$query_run = mysqli_query($con, $insert_cmnt);
			
			$select_cmnt = "SELECT * comment FROM product_reviews WHERE customer_email ='$c_email' AND product_id ='$pro_id'";
			*/
		...
		echo"
			...
			include("includes/db.php");
			$select_cmnt = "SELECT * FROM product_reviews2 WHERE product_id ='$pro_id'";
		...
		if(isset($_POST['comment'])&&isset($_POST['submit_comment']))
		{
			...
			$insert_cmnt = "INSERT INTO product_reviews2 (product_id, customer_email, comment) VALUES ('$pro_id','$user','$cmnt')";
