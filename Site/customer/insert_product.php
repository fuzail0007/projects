...
include("includes/db.php");
	...
	move_uploaded_file($product_image_tmp,"../admin_area/w_admin_src/w_product_images/$product_image"); /*admin_area/product_images/$pro_image'
	admin_area/w_admin_src/w_product_images
	*/
	...
	$insert_pros = "insert into wproducts (product_cat,product_brand,product_title,product_quantity,product_price,product_desc,product_image,product_keywords) values ('$product_cat','$product_brand','$product_title','$product_quantity','$product_price','$product_desc','$product_image','$product_keywords') ";
