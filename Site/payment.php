...
<input type="hidden" name="return" value="http://localhost/mysite/paypal_success.php" />
<input type="hidden" name="cancel_return" value="http://localhost/mysite/paypal_cancel.php" />
