...
<?php
                    	if(isset($_POST['update_cart']))
						{
							...
							{
							echo "<script>alert('Plaese Insert a Quantity!')</script>";
							}*/
						}
?>
...
<?php } } ?>
                ...
                <tr align="center">
                    ...
                    <td><button class="btn btn-success" ><a style="text-decoration:none; color:#000;" href = "checkout.php">CheckOut</a></button></td>
                </tr>
				</tbody>
...
<?php
			...
			if(isset($_POST['modify_cart']))
			{
				...
				{
					$delete_product = "delete from cart where p_id = '$remove_id' AND customer_email = '$c_email'";
				...
				{
					echo "<script>alert('Plaese select a product!')</script>";
				}*/
			}
