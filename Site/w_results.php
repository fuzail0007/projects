...
<div id="wrapper">
        ...
        $get_pro = "SELECT * FROM wproducts WHERE product_keywords like '%$search_query%'";
		...
		echo "
			...
			<div class='col-md-3'>
				...
				<h4 class='pull-right'><a href='index2.php?add_cart=$pro_id'><button class='btn btn-primary btn-xs'>Add to Cart</button></a></h4>
